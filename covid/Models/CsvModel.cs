...
namespace covid.Models
{
    public class CsvModel
    {
        ...
        [Name("total_cases")]
        public int TotalCases { get; set; }// Total confirmed cases of COVID-19	European Centre for Disease Prevention and Control

        [Name("new_cases")]
        public int NewCases { get; set; }// New confirmed cases of COVID-19	European Centre for Disease Prevention and Control
        ...
        [Name("total_deaths")]
        public int TotalDeaths { get; set; }// Total deaths attributed to COVID-19	European Centre for Disease Prevention and Control

        [Name("new_deaths")]
        public int NewDeaths { get; set; } // New deaths attributed to COVID-19	European Centre for Disease Prevention and Control
        ...
        [Name("total_tests")]
        public int TotalTests { get; set; }// Total tests for COVID-19	National government reports

        [Name("new_tests")]
        public int NewTests { get; set; }// New tests for COVID-19	National government reports
        ...
        [Name("population")]
        public int Population { get; set; }// Population in 2020	United Nations, Department of Economic and Social Affairs, Population Division, World Population Prospects: The 2019 Revision
        ...
        [Name("gdp_per_capita")]
        public double GdpPerCapita { get; set; }// Gross domestic product at purchasing power parity(constant 2011 international dollars), most recent year available World Bank – World Development Indicators, source from World Bank, International Comparison Program database
